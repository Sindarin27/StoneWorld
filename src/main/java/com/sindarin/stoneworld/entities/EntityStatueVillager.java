...
public class EntityStatueVillager extends VillagerEntity implements IPetrifiedCreature<VillagerEntity> {
    public EntityStatueVillager(EntityType<? extends VillagerEntity> type, World world) {
        super(type, world);
    }
    ...
    @Override
    public void handleStatusUpdate(byte p_70103_1_) { return; } //No matter what happens, a petrified entity should not display particles etc
